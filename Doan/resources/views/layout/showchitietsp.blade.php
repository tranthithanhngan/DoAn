							...
							<div class="product-information"><!--/product-information-->
								...
								<form action="{{URL::to('/giohang')}}" method="POST">
									...
									<input type="hidden" value="{{$value->idsanpham}}" class="cart_product_id_{{$value->idsanpham}}">
                                            ...
                                            <input type="hidden" value="{{$value->tensanpham}}" class="cart_product_name_{{$value->tensanpham}}">

                                            <input type="hidden" value="{{$value->hinhsanpham}}" class="cart_product_image_{{$value->hinhsanpham}}">

                                            <input type="hidden" value="{{$value->slsanpham}}" class="cart_product_quantity_{{$value->slsanpham}}">

                                            <input type="hidden" value="{{$value->giasanpham}}" class="cart_product_price_{{$value->giasanpham}}">
