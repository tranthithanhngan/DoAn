                    ...
                    <div class="col-sm-7">
                        ...
                        <div class="mainmenu pull-left">
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li class="dropdown"><a href="#" class ="{{Request::segment(1) == 'danh-muc' ? 'active' : ''}}">Danh mục <i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        @foreach($danhmuc as $key => $cate)
                                        <li><a  class="{{Request::segment(2) == $cate->id ? 'active' : ''}}" href="{{URL::to('/danh-muc/'.$cate->id)}}">{{$cate->tendanhmuc}}</a></li>
                                        @endforeach
                                    </ul>
                                </li> 
                        ...
                        <div class="brands_products row"><!--brands_products-->
                            ...
                            <div class="brands-name">
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    @foreach($danhmuc_by_id as $key => $dmbyid)
                                    <li><a href="{{URL::to('/thuong-hieu/'.$dmbyid->idthuonghieu)}}"> <span class="pull-right"></span>{{$dmbyid->tenthuonghieu}}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                        </div><!--/brands_products-->
                                ...
                                <div class="single-products">
                                        <div class="productinfo text-center">
                                            <form>
                                                ...
                                                <input type="hidden" value="{{number_format($sp->giasanpham,0,',','.').' '}}" id="wishlist_giasanpham{{$sp->idsanpham}}" class="cart_product_price_{{$sp->idsanpham}}">
