                    ...
                    <div class="col-sm-7">
                        ...
                        <div class="mainmenu pull-left">
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li><a href="/showgiohang" class ="{{Request::segment(1) == 'showgiohang' ? 'active' : ''}}">Giỏ hàng</a></li>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="cart_product">
                                                <a href="{{URL::to('/chi-tiet/'.$v_content->id)}}"><img src="{{URL::to('image/'.$v_content->options->image)}}" width="90" alt="" /></a>
                                            </td>
                                            <td class="cart_description">
                                                <h4><a href="{{URL::to('/chi-tiet/'.$v_content->id)}}">{{$v_content->name}}</a></h4>
                                            ...
                                            <td class="cart_delete">
                                                <a class="cart_quantity_delete" href="{{URL::to('/xoagiohang/'.$v_content->rowId)}}"><i class="fa fa-times"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="total_area">
                                        ...
                                        {{-- <li style="display: flex"><form action="{{URL::to('/capnhatgiohang')}}" method="POST"> --}}
                                        	{{-- <a class="btn btn-default update" href="">Update</a></form> --}}
                                              <?php
                                                   $customer_id = Session::get('customer_id');
                                                   if($customer_id!=NULL){ 
                                                 ?>
