                                        ...
                                        <div class="bill-to">
                                            ...
                                            <div class="form-one">
                                                <form action="{{url('/dangkithongtin')}}" method="POST">
                                                    ...
                                                    <a href="showgiohang">
                                                        <input type="submit" class="btn btn-default check_coupon" name="check_coupon"  value="Xem giỏ hàng"></a>
                                            ...
                                            <table class="table table-condensed">
                                                ...
                                                {{-- <tbody>
                                                    ...
                                                    @foreach(Session::get('cart') as $key => $cart)
                                                        @php
                                                        $subtotal = $cart[' giasanpham']*$cart['slsanpham'];
                                                            $total+=$subtotal;
                                                        @endphp
                
                                                    <tr>
                                                        <td class="cart_product">
                                                            <img src="{{asset('image'.$cart['product_image'])}}" width="90" alt="{{$cart['product_name']}}" />
                                                        </td>
