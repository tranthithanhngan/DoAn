                    ...
                    <div class="col-sm-7">
                        ...
                        <div class="mainmenu pull-left">
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li class="dropdown"><a href="#"class ="{{Request::segment(1) == 'baiviet' ? 'active' : ''}}">Tin tức<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                        ...
                        <div class="product-image-wrapper">
                            ...
                            <div class="single-products" style="margin: :10px 0;padding:5px 0">
                                <div class="text-center">
                                        ...
                                        {{-- <a href="{{URL::to('/bai-viet/'.$bv->baivietcon_id)}}"> --}}
                                            <img style="float:left;width:40%;padding:5px;border:none;" src="{{URL::to('image/'.$bv->hinhbaivietcon)}}" alt="{{$bv->hinhbaivietcon}}" />
                                           
                                            <p style="color: #000;padding:5px;">{{$bv->baivietcon_name}}</p>
                                            <p></p>
                                            <p >{{$bv->baivietcon_sum}}</p>
                                    ...
                                    <div class="text-right">
                                        <a href="{{URL::to('/xembaiviet/'.$bv->baivietcon_id)}}" class="btn btn-warning btn-sm">Xem bài viết</a>    
                                    </div>
                            </div>
