                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                <form role="form" action="{{URL::to('/luudanhmuc')}}" method="post">
                                    {{ csrf_field() }}
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Tên danh mục</label>
                                    <input type="text"  class="form-control"  onkeyup="ChangeToSlug();" name="tendanhmuc"  id="slug" placeholder="danh mục" >
                                </div>
                                {{-- <div class="form-group">
